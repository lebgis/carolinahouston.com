...
locate_template('/includes/admin/classes/zoner.class-init.php', true);
locate_template('/includes/admin/libs/execute-taxonomies.php', true); 
locate_template('/includes/admin/zoner-options/admin-config.php', true);
locate_template('/includes/admin/libs/execute-posttypes.php', true);
...
locate_template('/includes/theme/theme-wnd.php', true);
locate_template('/includes/theme/theme-profile.php', true);
locate_template('/includes/theme/theme-edit-property.php', true);
locate_template('/includes/theme/theme-edit-agency.php', true);
locate_template('/includes/theme/theme-inlinestyles.php', true);
locate_template('/includes/theme/theme-oauth2.php', true);
