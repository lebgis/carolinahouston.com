				...
				<table border="0" cellpadding="0" cellspacing="0" width="650" id="mainBody" style="background-image:url(<?php echo esc_url($bg_image_url); ?>);">
					<tr>
						<td style="padding:55px 50px;">
							...
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php printf(__('Your membership package on  %1s is deactivated!', 'zoner'), get_bloginfo('name')); ?></p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php _e('All your listings are no longer visible for our visitors but remain in your dashborad.', 'zoner'); ?></p>
						</td>
					</tr>
				</table>
			</td>
