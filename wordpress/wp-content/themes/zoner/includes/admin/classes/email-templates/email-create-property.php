				...
				<table border="0" cellpadding="0" cellspacing="0" width="650" id="mainBody" style="background-image:url(<?php echo esc_url($bg_image_url); ?>);">
					<tr>
						<td style="padding:55px 50px;">
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><strong><?php _e('Property waiting for approval.', 'zoner'); ?></strong></p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php printf(__('User: <strong>%1s</strong> <a href="mailto:%2s">%3s</a>', 'zoner'), $agentName, $agentEmail, $agentEmail); ?></p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php printf(__('Property name: <strong><a href="%1s">%2s</a></strong>', 'zoner'),   $propertyLink, $propertyTitle);?></p>
						</td>
					</tr>
				</table>
			</td>
