<?php
	global $zoner, $zoner_config, $userName, $userEmail, $userMessage, $agentName, $pageLink;
				...
				<table  border="0" cellpadding="0" cellspacing="0" width="650" id="mainBody" style="background-image:url(<?php echo esc_url($bg_image_url); ?>);">
					<tr>
						<td style="padding:50px 50px;">
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><strong><?php printf(__('Hello, %1s!', 'zoner'), $agentName); ?></strong></p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php _e('You received a letter from', 'zoner'); ?>:</p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><span style="color:#1396e2;"><?php _e('Name', 'zoner'); ?> </span>: <?php echo $userName; ?> <br /> 
							   <span style="color:#1396e2;"><?php _e('E-mail', 'zoner'); ?></span>: <span style="color:#1396e2; text-decoration:none;">	<?php echo $userEmail; ?></span></p>
							<p style="font-family:'Roboto',sans-serif;font-size:14px; color:#2a2a2a;font-weight:normal;"><span style="color:#1396e2;"><?php _e('Message', 'zoner'); ?></span>: <?php echo $userMessage; ?></p>
							
							<p style="font-family:'Roboto',sans-serif;font-size:14px; color:#2a2a2a;font-weight:normal;"><span style="color:#1396e2;"><?php _e('Send from the page', 'zoner'); ?></span>: <?php echo $pageLink; ?></p>
						</td>
					</tr>	
				</table>
			</td>
