...
top: 0;
z-index: <?php echo (isset($this->settings['slider_transit']) && $this->settings['slider_transit'] == 3)?9999999:-1;?>;
height: 100%;
width: 500px;
overflow-x: hidden;
overflow-y: hidden;
...
<?php if(isset($this->settings['slider_transit']) && $this->settings['slider_transit'] > 1){?>
.wpmchimpas-resp{
