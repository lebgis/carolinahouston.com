				...
				<table border="0" cellpadding="0" cellspacing="0" width="650" id="mainBody" style="background-image:url(<?php echo esc_url($bg_image_url); ?>);">
					<tr>
						<td style="padding:55px 50px;">
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><strong><?php _e('New user is registered!', 'zoner'); ?></strong></p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php  printf(__('User name: <strong>%1s</strong>', 'zoner'), $userName); ?></p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php  printf(__('User email: <strong>%1s</strong>', 'zoner'), $userEmail); ?></p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php  printf(__('User role: <strong>%1s</strong>', 'zoner'), $userRole); ?></p>
						</td>
					</tr>
				</table>
			</td>
