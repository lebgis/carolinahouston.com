<?php
	...
	$addPropLink 	 = add_query_arg(array('add-property' => $userIDout) , site_url(''));
	$addAgencyLink   = add_query_arg(array('add-agency'   => $userIDout) , site_url(''));
	$inviteAgentLink = add_query_arg(array('profile-page' => 'my_invites'), get_author_posts_url($userIDout));
	$rtl = is_rtl() ? 'dir="rtl"' : '';
?>
			...
			<td>
				<table border="0" cellpadding="0" cellspacing="0" width="650" id="mainBody">
					...
					<tr>
						...
						<td style="padding:20px 50px 0 18px;"><a href="<?php echo $addPropLink; ?>"><img src="<?php echo $email_btn_2; ?>" alt="" /></a></td>
					</tr>
					<tr>
						<td style="padding:20px 0 0 50px;"><a href="<?php echo $addAgencyLink; ?>"><img src="<?php echo $email_btn_3; ?>" alt="" /></a></td>
						<td style="padding:20px 50px 0 18px;"><a href="<?php echo $inviteAgentLink; ?>"><img src="<?php echo $email_btn_4; ?>" alt="" /></a></td>
					</tr>
				</table>
			</td>
		</tr>
