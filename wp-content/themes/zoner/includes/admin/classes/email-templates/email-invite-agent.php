<?php
	global $zoner, $zoner_config, $userName, $agencyName, $inviteLink;
				...
				<table  border="0" cellpadding="0" cellspacing="0" width="650" id="mainBody" style="background-image:url(<?php echo esc_url($bg_image_url); ?>);">
					<tr>
						<td style="padding:50px 50px;">
							...
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php printf(__('You have been invited to the real estate agency <strong>"%1s"</strong> <br /> To confirm click on the link', 'zoner'), $agencyName); ?>:</p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><a href="<?php echo esc_url($inviteLink); ?>"><?php _e('Click here', 'zoner'); ?></a></p>
						</td>
					</tr>
				</table>
			</td>
