				...
				<table  border="0" cellpadding="0" cellspacing="0" width="650" id="mainBody" style="background-image:url(<?php echo esc_url($bg_image_url); ?>);">
					<tr>
						<td style="padding:50px 50px;">
							...
							<p style="font-family:'Roboto',sans-serif;font-size:14px; color:#2a2a2a;font-weight:normal;"><?php _e('Your property has changed status to published', 'zoner'); ?></p>
							<p style="font-family:'Roboto',sans-serif;font-size:14px; color:#2a2a2a;font-weight:normal;"><strong><?php _e('Property name', 'zoner')?></strong>: <a href="<?php echo $propertyLink; ?>"><?php echo $propertyName; ?></a></p>
						</td>
					</tr>	
				</table>
			</td>
