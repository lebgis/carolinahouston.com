<?php
	global $zoner, $zoner_config, $userName, $tempPass, $userEmail;
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
	<table align="cneter" width="100%" id="mainTable" class="mainTable" class="center"  border="0" cellspacing="0" cellpadding="0" style="background-color:#fff; padding:0; margin:0;font-family:'Roboto',sans-serif;font-size:14px; color:#2a2a2a;font-weight:normal;">
		<tr>
			<td>
				<table <?php echo $rtl ?> border="0" cellpadding="0" cellspacing="0" width="650" id="mainHeader" style="border-bottom:1px solid #d7d7d7;">
					<tr>
				...
				<table  border="0" cellpadding="0" cellspacing="0" width="650" id="mainBody" style="background-image:url(<?php echo esc_url($bg_image_url); ?>);">
					<tr>
						<td style="padding:50px 50px;">
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><strong><?php printf(__('Hello, %1s!', 'zoner'), $userName); ?></strong><br />
							<?php _e('Your current password has been reset.', 'zoner'); ?> </p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php _e('Your temporary password', 'zoner'); ?>: <span style="color:#1396e2;"><strong><?php echo $tempPass; ?></strong></span></p>
							<p style="font-family:'Roboto',sans-serif; font-size:14px; color:#2a2a2a; font-weight:normal;"><?php _e('If you continue to have problems, please feel free to contact us', 'zoner') ?>: <span style="color:#1396e2; text-decoration:none;"><?php echo $zoner->emails->zoner_get_from_email(); ?></span></p>
						</td>
					</tr>
				</table>
			</td>
